...
write_csv(dd, here("data","Fig3_data.csv"))
...
write_csv(d1a, here("data","Fig4_data.csv"))
...
ggsave(here("plots", "Figure4.svg"), Fig4, height = 10, width = 10)
...
p5 <- plot(conditional_effects(mSSemLvl), plot=F, points=T)[[2]] + theme_classic()
p6 <- plot(conditional_effects(mSSemLvl_T), plot=F, points=T)[[2]] + theme_classic()

(p1 + p3) / (p2 + p4)
ggsave(here("plots", "Figure5.svg"), width=10, height=10)
