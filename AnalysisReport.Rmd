...
```{r SurveyData}
Data=read.table('AlienSurvey.txt', header=TRUE) # Name of the file
...
model1=lmer(Effort~Condition+(1|Pair),REML=F,Data)
ModelDiagnostics(model1,linear=T)

by(Data$Effort,Data$Condition,stat.desc)

model2=lmer(Motivation~Condition+(1|Pair),REML=F,Data)
